...
loader.add("./idle_animation.json").load(setup)
function setup() {
  // get a reference to the sprite sheet we've just loaded:
  let sheet = loader.resources["./idle_animation.json"].spritesheet;
  console.log(sheet)

  let avatar = new PIXI.AnimatedSprite(sheet.animations["idle"]);
  avatar.play();
  avatar.animationSpeed = 0.1
  avatar.scale.set(3);
